...
function HomeGame() {
  ...
  const [mudaLvl, setMudaLvl] = useState(false);
  ...
  function modificaNivel(parametro) {
    if (parametro === 0) {
      if (levelAtual === 1) {
        setMudaLvl(true);
      } else {
        setLevelAtual(levelAtual - 2)
        setMudaLvl(true);
      }
    } else {
      if (levelAtual === 16 || levelAtual > 16) {
        setMudaLvl(true);
      } else {
        setMudaLvl(true);
      }
      ...
      <Card className="mt-3">
        <Card.Body>
          <Container fluid>
            <Row>
              <Col className="align">
                <span className="level">Level {levelAtualTela}</span>
              </Col>
            </Row>
            <Row>
              <Col className="align">
                <span className="blind"> Blind {blindAtual}</span>
              </Col>
            </Row>
            <Row>
              <Col className="align">
                <span className="nextLevel">Next Level - {nextBlind}</span>
              </Col>
            </Row>
            <br></br>
            <Row>
